...
* It covers a fundamental tensorflow tutorial on semantic segmentation, with keras features to augment a small dataset and creating efficient data generators
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/schutera/Tutorial-3-Semantic-Segmentation-with-U-Net/HEAD?labpath=UNet-TUT.ipynb)


<!-- ROADMAP -->
## Roadmap

See the [open issues](https://github.com/schutera/Tutorial-3-Semantic-Segmentation-with-U-Net/issues) for a full list of proposed features (and known issues).
